...
function Cuenta() {
  ...
  return (
    <div className="mx-auto max-w-md space-y-6">
      ...
      {estado.fase === "cargando" && <p className="text-stone-500">Cargando…</p>}
        ...
        <div className="space-y-4 rounded-xl border border-emerald-200 bg-white p-5">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <button
              ...
              className="rounded-lg border border-stone-300 px-4 py-2 font-medium text-stone-600 hover:bg-stone-50"
            >
              Cerrar sesión
            </button>
          </div>
      ...
      {estado.fase === "enlace-enviado" && (
        <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-5">
          <p className="font-medium text-emerald-950">📬 Revisa tu correo</p>
      ...
      {estado.fase === "anonimo" && (
        <div className="space-y-4">
          ...
          <form onSubmit={enviaEnlace} className="space-y-3 rounded-xl border border-stone-200 bg-white p-5">
            <label className="block">
              <span className="text-sm font-medium text-stone-700">Tu email</span>
              <input
                type="email"
                required
                value={email}
                ...
                className="mt-1 w-full rounded-lg border border-stone-300 px-3 py-2 outline-none focus:border-emerald-600 focus:ring-2 focus:ring-emerald-100"
              />
            </label>
            <button
              type="submit"
